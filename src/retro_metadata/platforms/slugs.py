"""Universal platform slug enumeration.

This enum provides a standardized set of platform identifiers that can be
mapped to provider-specific platform IDs.
"""
...
class UniversalPlatformSlug(enum.StrEnum):
    """Universal platform slugs for cross-provider compatibility.

    These slugs serve as a common identifier that can be mapped to
    ...
    TOMY_TUTOR_SLASH_PYUTA_SLASH_GRANDSTAND_TUTOR = "tomy-tutor-slash-pyuta-slash-grandstand-tutor"
    TRITON = "triton"
    TRS_80 = "trs-80"
